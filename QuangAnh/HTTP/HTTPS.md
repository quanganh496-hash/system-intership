...
1. Tin nhắn 'client hello': Khách hàng bắt đầu bắt tay bằng cách gửi tin nhắn "xin chào" đến máy chủ. Tin nhắn sẽ bao gồm phiên bản TLS mà khách hàng hỗ trợ, các bộ mật mã được hỗ trợ và một chuỗi các byte ngẫu nhiên được gọi là "khách hàng ngẫu nhiên".

2. Tin nhắn 'server hello': Để trả lời tin nhắn xin chào của khách hàng, máy chủ sẽ gửi một tin nhắn chứa chứng chỉ SSL của máy chủ, bộ mật mã đã chọn của máy chủ và "máy chủ ngẫu nhiên", một chuỗi byte ngẫu nhiên khác do máy chủ tạo ra.
